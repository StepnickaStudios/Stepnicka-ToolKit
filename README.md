...
[Github] (https://github.com/StepnickaStudios/) <br>
[Youtube] (https://www.youtube.com/@StepLauncher-MC)

<div class="HowToUse">
    <h1> How To Use It? <h1> <br>
    <h3>
    Type !ST and the snippets will appear. It depends on the language you're using. For example, if you're using <br> JavaScript, snippets for that language will appear. The same will happen with HTML. HTML snippets will appear.
    </h3>
</div>
<br>
...
<img src="Icon.png" style="width: 20rem; border-radius:1rem; box-shadow: 0rem 0rem 1rem blue;">
<hr>
